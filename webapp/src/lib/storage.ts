...
export class Storage implements IStorage {
  ...
  public async save(game: IGame, name: string) {
    ...
    const payload: StorageSavePayload = {
      game: game.getDataPayload(),
      world: game.world.getDataPayload(),
      level: game.world.level.getDataPayload(),
      player: game.world.player.getDataPayload(),
      wave: game.world.wave.getDataPayload(),
    };
